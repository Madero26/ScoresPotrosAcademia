// controllersCoord/entrenadoresCoordController.js
...
const backCrear = '/adminCoordinador/CoordCrearEntrenador';
const backGestionar = id =>
  id ? `/adminCoordinador/CoordGestionarEntrenador?id=${id}`
     : '/adminCoordinador/CoordGestionarEntrenador';

/* Listar/Obtener (JSON opcional) */
...
async function eliminar(req, res) {
  ...
  try {
    const r = await db.query(
      `DELETE FROM Entrenadores WHERE id_entrenador=?`,
      [req.params.id]
    );
